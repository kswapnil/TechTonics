			...
			<div class="box">
				<div class="col-lg-12 text-center">
					<input type="submit" class="btn-danger btn-lg"
						onclick="location.href = 'makeRequest.jsp';" value="Request For Talk" />
					...
					<table class="table text-color text-left">
						...
						%>
								...
								<tr class="default ">
									...
									<td><input type=button class="btn-link " value="Want to Attend" onclick="location.href = 'wantToattend?topic=<%=obj.getTopic() %>&emp=<%=request.getSession().getAttribute("username") %>';"></td>
								</tr>
							<%} %>
